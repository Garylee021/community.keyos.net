<div class='nightly-builds-page'>
  ...
  They undergo a sequence of automated [smoke tests](https://github.com/Garylee021/keyos-1x/tree/current/smoketest/scripts/cli).
  In addition we load arbitrary [configurations](https://github.com/Garylee021/keyos-1x/tree/current/smoketest/configs) to ensure
  ...
  If in doubt, you can get the public key from the [nightly builds repository](https://github.com/Garylee021/keyos-nightly-build/blob/main/minisign.pub).
  ...
  Currently, we create rolling release builds with GitHub Actions and store them in releases of the [keyos/keyos-nightly-build](https://github.com/Garylee021/keyos-nightly-build/releases)
