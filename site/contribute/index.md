<div class='contribute-page'>
  ...
  # Contributing to KeyOS

  KeyOS development process is open and transparent. We welcome everyone to contribute!
  ...
  The copyrights to KeyOS source code and documentation remain shared between all
  ...
  documentation, or promotes KeyOS in the social media or at live events.
  ...
  We also have [badges](https://www.youracclaim.com/organizations/keyos/badges)!
  ...
  * Read the [introduction to KeyOS development](https://docs.keyos.io/en/latest/contributing/development.html).
  * Browse [open tasks](https://keyos.dev/maniphest/query/YqwCUwoj7wWx/#R).
  ...
  * Reports bugs in [Phabricator](https://keyos.dev/maniphest).

  ### Spreading the word

  * Write about KeyOS in your own blog or website.
  * Write about KeyOS and share our posts on social media.
  * Speak about KeyOS at conferenced and meetups.
